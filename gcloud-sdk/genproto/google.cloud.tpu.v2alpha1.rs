...
pub mod queued_resource {
    ...
    pub mod queueing_policy {
        ...
        pub enum StartTimingConstraints {
            ...
            /// failed.
            #[prost(message, tag = "1")]
            ValidUntilDuration(::prost_wkt_types::Duration),
            /// An absolute time after which resources should not be created.
            /// If the request cannot be fulfilled by this time the request will be
            /// failed.
            #[prost(message, tag = "2")]
            ValidUntilTime(::prost_wkt_types::Timestamp),
            /// A relative time after which resources may be created.
            #[prost(message, tag = "3")]
            ValidAfterDuration(::prost_wkt_types::Duration),
            /// An absolute time at which resources may be created.
            #[prost(message, tag = "4")]
            ValidAfterTime(::prost_wkt_types::Timestamp),
