...
pub mod constant {
    ...
    pub enum ConstantKind {
        /// null value.
        #[prost(enumeration = "::prost_wkt_types::NullValue", tag = "1")]
        NullValue(i32),
        /// boolean value.
        #[prost(bool, tag = "2")]
        BoolValue(bool),
...
pub mod r#type {
    ...
    pub enum TypeKind {
        /// Dynamic type.
        #[prost(message, tag = "1")]
        Dyn(::prost_wkt_types::Empty),
        /// Null value.
        #[prost(enumeration = "::prost_wkt_types::NullValue", tag = "2")]
        Null(i32),
...
pub mod value {
    ...
    pub enum Kind {
        ...
        ObjectValue(::prost_wkt_types::Any),
        /// Map value.
        #[prost(message, tag = "11")]
