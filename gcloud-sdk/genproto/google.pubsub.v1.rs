...
pub struct Topic {
    ...
    pub message_retention_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct RetryPolicy {
    ...
    #[prost(message, optional, tag = "1")]
    pub minimum_backoff: ::core::option::Option<::prost_wkt_types::Duration>,
    /// Optional. The maximum delay between consecutive deliveries of a given
    /// message. Value should be between 0 and 600 seconds. Defaults to 600
    /// seconds.
    #[prost(message, optional, tag = "2")]
    pub maximum_backoff: ::core::option::Option<::prost_wkt_types::Duration>,
}
...
pub mod seek_request {
    ...
    pub enum Target {
        ...
        #[prost(message, tag = "2")]
        Time(::prost_wkt_types::Timestamp),
