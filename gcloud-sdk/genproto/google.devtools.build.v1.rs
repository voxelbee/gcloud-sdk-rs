...
pub struct BuildStatus {
    ...
    pub build_tool_exit_code: ::core::option::Option<pb::Int32Value>,
    ...
    pub details: ::core::option::Option<::prost_wkt_types::Any>,
}
...
pub mod build_event {
    ...
    pub enum Event {
        ...
        BazelEvent(::prost_wkt_types::Any),
        /// An event that contains supplemental tool-specific information about
        /// build execution.
        #[prost(message, tag = "61")]
        BuildExecutionEvent(::prost_wkt_types::Any),
        /// An event that contains supplemental tool-specific information about
        /// source fetching.
        #[prost(message, tag = "62")]
        SourceFetchEvent(::prost_wkt_types::Any),
    }
}
...
pub struct PublishLifecycleEventRequest {
    ...
    #[prost(message, optional, tag = "3")]
    pub stream_timeout: ::core::option::Option<::prost_wkt_types::Duration>,
