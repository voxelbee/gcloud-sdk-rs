...
pub struct TestSpecification {
    ...
    pub test_timeout: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct SmartSharding {
    ...
    #[prost(message, optional, tag = "1")]
    pub targeted_shard_duration: ::core::option::Option<::prost_wkt_types::Duration>,
}
/// Output only. Details about the shard.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
...
pub struct Shard {
    ...
    #[prost(message, optional, tag = "4")]
    pub estimated_shard_duration: ::core::option::Option<::prost_wkt_types::Duration>,
}
...
pub struct DeviceSession {
    ...
    #[prost(message, optional, tag = "7")]
    pub inactivity_timeout: ::core::option::Option<::prost_wkt_types::Duration>,
    /// Output only. The time that the Session was created.
    #[prost(message, optional, tag = "8")]
    pub create_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. The timestamp that the session first became ACTIVE.
    #[prost(message, optional, tag = "9")]
    pub active_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct Distribution {
    ...
    #[prost(message, optional, tag = "1")]
    pub measurement_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
