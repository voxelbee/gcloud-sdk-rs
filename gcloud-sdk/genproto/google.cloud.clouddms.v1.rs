...
pub struct SqlIpConfig {
    ...
    pub enable_ipv4: ::core::option::Option<super::super::super::protobuf::BoolValue>,
...
pub struct CloudSqlSettings {
    ...
    #[prost(message, optional, tag = "7")]
    pub auto_storage_increase: ::core::option::Option<
...
pub struct ConversionWorkspace {
    ...
    #[prost(message, optional, tag = "7")]
    pub latest_commit_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct SingleColumnChange {
    ...
    #[prost(message, optional, tag = "13")]
    pub custom_features: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub mod value_transformation {
    ...
    pub enum Action {
        ...
        AssignNull(::prost_wkt_types::Empty),
...
pub mod apply_hash {
    ...
    pub enum HashFunction {
        ...
        #[prost(message, tag = "100")]
        UuidFromBytes(::prost_wkt_types::Empty),
    }
}
...
pub struct SearchBackgroundJobsRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub completed_until_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
