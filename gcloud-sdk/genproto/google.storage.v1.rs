...
pub struct Bucket {
    ...
    pub time_created: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    pub updated: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod bucket {
    ...
    pub mod iam_configuration {
        ...
        pub struct UniformBucketLevelAccess {
            ...
            pub locked_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
        }
    ...
    pub mod lifecycle {
        ...
        pub mod rule {
            ...
            pub struct Condition {
                ...
                #[prost(message, optional, tag = "2")]
                pub created_before: ::core::option::Option<::prost_wkt_types::Timestamp>,
                /// Relevant only for versioned objects. If the value is
                /// `true`, this condition matches live objects; if the value
                /// is `false`, it matches archived objects.
                #[prost(message, optional, tag = "3")]
                pub is_live: ::core::option::Option<
    ...
    pub struct Autoclass {
        ...
        #[prost(message, optional, tag = "2")]
        pub toggle_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    }
}
...
pub struct ChecksummedData {
    ...
    #[prost(message, optional, tag = "2")]
    pub crc32c: ::core::option::Option<pb::UInt32Value>,
}
...
pub struct Object {
    ...
    /// [FieldViolation][google.rpc.BadRequest.FieldViolation].
    #[prost(message, optional, tag = "7")]
    pub time_deleted: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    /// [FieldViolation][google.rpc.BadRequest.FieldViolation].
    #[prost(message, optional, tag = "18")]
    pub time_storage_class_updated: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    /// temporary hold).
    #[prost(message, optional, tag = "20")]
    pub retention_expiration_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    pub event_based_hold: ::core::option::Option<super::super::protobuf::BoolValue>,
    ...
    pub custom_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct DeleteBucketRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub if_metageneration_match: ::core::option::Option<pb::Int64Value>,
    /// If set, only deletes the bucket if its metageneration does not match this
    /// value.
    #[prost(message, optional, tag = "3")]
    pub if_metageneration_not_match: ::core::option::Option<pb::Int64Value>,
    /// A set of parameters common to all Storage API requests.
    #[prost(message, optional, tag = "5")]
    pub common_request_params: ::core::option::Option<CommonRequestParams>,
}
...
pub struct ComposeObjectRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub if_generation_match: ::core::option::Option<pb::Int64Value>,
...
pub struct CopyObjectRequest {
    ...
    #[prost(message, optional, tag = "5")]
    pub if_generation_not_match: ::core::option::Option<pb::Int64Value>,
    /// Makes the operation conditional on whether the destination object's current
    /// metageneration matches the given value.
    #[prost(message, optional, tag = "6")]
    pub if_metageneration_match: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "8")]
    pub if_source_generation_match: ::core::option::Option<pb::Int64Value>,
    /// Makes the operation conditional on whether the source object's current
    /// generation does not match the given value.
    #[prost(message, optional, tag = "9")]
    pub if_source_generation_not_match: ::core::option::Option<pb::Int64Value>,
    /// Makes the operation conditional on whether the source object's current
    /// metageneration matches the given value.
    #[prost(message, optional, tag = "10")]
    pub if_source_metageneration_match: ::core::option::Option<pb::Int64Value>,
    /// Makes the operation conditional on whether the source object's current
    /// metageneration does not match the given value.
    #[prost(message, optional, tag = "11")]
    pub if_source_metageneration_not_match: ::core::option::Option<pb::Int64Value>,
    /// Set of properties to return. Defaults to `NO_ACL`, unless the
...
pub struct CommonRequestParams {
    ...
    #[prost(message, optional, tag = "4")]
    pub fields: ::core::option::Option<::prost_wkt_types::FieldMask>,
}
