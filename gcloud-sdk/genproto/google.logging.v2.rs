...
pub struct LogEntry {
    ...
    pub receive_timestamp: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod log_entry {
    ...
    pub enum Payload {
        ...
        #[prost(message, tag = "2")]
        ProtoPayload(::prost_wkt_types::Any),
        ...
        #[prost(message, tag = "6")]
        JsonPayload(::prost_wkt_types::Struct),
    }
}
...
pub struct TailLogEntriesRequest {
    ...
    pub buffer_window: ::core::option::Option<::prost_wkt_types::Duration>,
}
