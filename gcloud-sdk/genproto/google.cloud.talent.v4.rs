...
pub mod compensation_info {
    ...
    pub struct CompensationEntry {
        ...
        pub expected_units_per_year: ::core::option::Option<
...
pub struct Job {
    ...
    pub job_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The end timestamp of the job. Typically this field is used for contracting
    /// engagements. Invalid timestamps are ignored.
    #[prost(message, optional, tag = "23")]
    pub job_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The timestamp this job posting was most recently published. The default
    /// value is the time the request arrives at the server. Invalid timestamps are
    /// ignored.
    #[prost(message, optional, tag = "24")]
    pub posting_publish_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Strongly recommended for the best service experience.
    ///
    ...
    pub posting_expire_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. The timestamp when this job posting was created.
    #[prost(message, optional, tag = "26")]
    pub posting_create_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. The timestamp when this job posting was last updated.
    #[prost(message, optional, tag = "27")]
    pub posting_update_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
