...
pub struct AutomatedBackupPolicy {
    ...
    pub backup_window: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct ContinuousBackupInfo {
    ...
    pub enabled_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    pub earliest_restorable_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct GenerateClientCertificateRequest {
    ...
    /// default duration.
    #[prost(message, optional, tag = "4")]
    pub cert_duration: ::core::option::Option<::prost_wkt_types::Duration>,
