...
pub struct Insight {
    ...
    pub content: ::core::option::Option<::prost_wkt_types::Struct>,
    /// Timestamp of the latest data used to generate the insight.
    #[prost(message, optional, tag = "4")]
    pub last_refresh_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Observation period that led to the insight. The source data used to
    /// generate the insight ends at last_refresh_time and begins at
    /// (last_refresh_time - observation_period).
    #[prost(message, optional, tag = "5")]
    pub observation_period: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct RecommendationContent {
    ...
    #[prost(message, optional, tag = "3")]
    pub overview: ::core::option::Option<::prost_wkt_types::Struct>,
}
