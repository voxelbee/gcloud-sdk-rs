...
pub struct BasicAutoscalingAlgorithm {
    ...
    pub cooldown_period: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct ExecutionConfig {
    ...
    pub idle_ttl: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct Batch {
    ...
    pub state_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod batch {
    ...
    pub struct StateHistory {
        ...
        #[prost(message, optional, tag = "3")]
        pub state_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    }
    /// The batch state.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(
...
pub struct LifecycleConfig {
    ...
    /// [Duration](<https://developers.google.com/protocol-buffers/docs/proto3#json>)).
    #[prost(message, optional, tag = "1")]
    pub idle_delete_ttl: ::core::option::Option<::prost_wkt_types::Duration>,
    /// Output only. The time when cluster became idle (most recent job finished)
    /// and became eligible for deletion due to idleness (see JSON representation
    /// of
    /// [Timestamp](<https://developers.google.com/protocol-buffers/docs/proto3#json>)).
    #[prost(message, optional, tag = "4")]
    pub idle_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod lifecycle_config {
    ...
    pub enum Ttl {
        ...
        /// [Timestamp](<https://developers.google.com/protocol-buffers/docs/proto3#json>)).
        #[prost(message, tag = "2")]
        AutoDeleteTime(::prost_wkt_types::Timestamp),
        /// Optional. The lifetime duration of cluster. The cluster will be
        /// auto-deleted at the end of this period. Minimum value is 10 minutes;
        /// maximum value is 14 days (see JSON representation of
        /// [Duration](<https://developers.google.com/protocol-buffers/docs/proto3#json>)).
        #[prost(message, tag = "3")]
        AutoDeleteTtl(::prost_wkt_types::Duration),
    }
}
...
pub struct WorkflowTemplate {
    ...
    #[prost(message, optional, tag = "10")]
    pub dag_timeout: ::core::option::Option<::prost_wkt_types::Duration>,
}
...
pub struct WorkflowMetadata {
    ...
    /// DAG begins.
    #[prost(message, optional, tag = "13")]
    pub dag_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. DAG end time, only set for workflows with
    /// [dag_timeout][google.cloud.dataproc.v1.WorkflowMetadata.dag_timeout] when
    /// DAG ends.
    #[prost(message, optional, tag = "14")]
    pub dag_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
