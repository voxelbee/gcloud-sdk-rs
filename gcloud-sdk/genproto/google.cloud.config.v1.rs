...
pub struct TerraformVariable {
    ...
    pub input_value: ::core::option::Option<::prost_wkt_types::Value>,
}
...
pub struct TerraformVersion {
    ...
    #[prost(message, optional, tag = "3")]
    pub support_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. When the version is deprecated.
    #[prost(message, optional, tag = "4")]
    pub deprecate_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. When the version is obsolete.
    #[prost(message, optional, tag = "5")]
    pub obsolete_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
