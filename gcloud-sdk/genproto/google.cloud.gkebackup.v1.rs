...
pub struct Backup {
    ...
    pub delete_lock_expire_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    pub retain_expire_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod backup_plan {
    ...
    pub struct Schedule {
        ...
        #[prost(message, optional, tag = "4")]
        pub next_scheduled_backup_time: ::core::option::Option<
