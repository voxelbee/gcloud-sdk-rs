...
pub struct AuditLog {
    ...
    pub resource_original_state: ::core::option::Option<::prost_wkt_types::Struct>,
    ...
    pub service_data: ::core::option::Option<::prost_wkt_types::Any>,
}
...
pub struct AuthenticationInfo {
    ...
    /// name will be indicated in the `@type` property.
    #[prost(message, optional, tag = "4")]
    pub third_party_principal: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub mod service_account_delegation_info {
    ...
    pub struct FirstPartyPrincipal {
        ...
        #[prost(message, optional, tag = "2")]
        pub service_metadata: ::core::option::Option<::prost_wkt_types::Struct>,
    }
    ...
    pub struct ThirdPartyPrincipal {
        ...
        pub third_party_claims: ::core::option::Option<::prost_wkt_types::Struct>,
    }
    /// Entity that creates credentials for service account and assumes its
    /// identity for authentication.
    #[derive(serde::Serialize, serde::Deserialize)]
