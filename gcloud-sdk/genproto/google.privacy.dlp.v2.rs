...
pub struct Finding {
    ...
    pub job_create_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The job that stored the finding.
    #[prost(string, tag = "13")]
...
pub struct ContentLocation {
    ...
    #[prost(message, optional, tag = "6")]
    pub container_timestamp: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod quasi_id {
    ...
    pub enum Tag {
        ...
        #[prost(message, tag = "4")]
        Inferred(::prost_wkt_types::Empty),
    }
}
...
pub mod schedule {
    ...
    pub enum Option {
        ...
        #[prost(message, tag = "1")]
        RecurrencePeriodDuration(::prost_wkt_types::Duration),
    }
}
...
pub struct Error {
    ...
    /// last 9 timestamps.
    #[prost(message, repeated, tag = "2")]
    pub timestamps: ::prost::alloc::vec::Vec<::prost_wkt_types::Timestamp>,
}
...
pub struct DiscoveryBigQueryConditions {
    ...
    /// backfilling.
    #[prost(message, optional, tag = "1")]
    pub created_after: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod discovery_big_query_conditions {
    ...
    pub struct OrConditions {
        ...
        #[prost(message, optional, tag = "2")]
        pub min_age: ::core::option::Option<::prost_wkt_types::Duration>,
    }
    /// The type of BigQuery tables to scan. If nothing is set the default
    /// behavior is to scan only tables of type TABLE and to give errors
    /// for all unsupported tables.
...
pub struct ProjectDataProfile {
    ...
    #[prost(message, optional, tag = "3")]
    pub profile_last_generated: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct DataProfileConfigSnapshot {
    ...
    #[prost(message, optional, tag = "6")]
    pub inspect_template_modified_time: ::core::option::Option<
