...
pub struct ListGroupStatsRequest {
    ...
    pub timed_count_duration: ::core::option::Option<::prost_wkt_types::Duration>,
    ...
    pub alignment_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct ListGroupStatsResponse {
    ...
    pub time_range_begin: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct ErrorGroupStats {
    ...
    #[prost(message, optional, tag = "5")]
    pub first_seen_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Approximate last occurrence that was ever seen for this group and
    /// which matches the given filter criteria, ignoring the time_range
    /// that was specified in the request.
    #[prost(message, optional, tag = "6")]
    pub last_seen_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
