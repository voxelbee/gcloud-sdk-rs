...
pub struct DeliveryVehicle {
    ...
    /// `current_route_segment` field is empty.
    #[prost(message, optional, tag = "7")]
    pub remaining_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct VehicleJourneySegment {
    ...
    #[prost(message, optional, tag = "2")]
    pub driving_distance_meters: ::core::option::Option<pb::Int32Value>,
    ...
    #[prost(message, optional, tag = "3")]
    pub driving_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub mod vehicle_stop {
    ...
    pub struct TaskInfo {
        ...
        #[prost(message, optional, tag = "2")]
        pub task_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct Task {
    ...
    /// provider.
    #[prost(message, optional, tag = "10")]
    pub task_outcome_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod task_tracking_view_config {
    ...
    pub mod visibility_option {
        ...
        pub enum VisibilityOption {
            ...
            #[prost(message, tag = "2")]
            DurationUntilEstimatedArrivalTimeThreshold(::prost_wkt_types::Duration),
...
pub struct TaskTrackingInfo {
    ...
    #[prost(message, optional, tag = "5")]
    pub remaining_stop_count: ::core::option::Option<pb::Int32Value>,
    /// The total remaining distance in meters to the `VehicleStop` of interest.
    #[prost(message, optional, tag = "6")]
    pub remaining_driving_distance_meters: ::core::option::Option<pb::Int32Value>,
    /// The timestamp that indicates the estimated arrival time to the stop
    /// location.
    #[prost(message, optional, tag = "7")]
    pub estimated_arrival_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The timestamp that indicates the estimated completion time of a Task.
    #[prost(message, optional, tag = "8")]
    pub estimated_task_completion_time: ::core::option::Option<
