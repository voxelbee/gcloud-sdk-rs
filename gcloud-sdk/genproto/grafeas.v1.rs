...
pub struct Recipe {
    ...
    pub arguments: ::prost::alloc::vec::Vec<::prost_wkt_types::Any>,
    /// Any other builder-controlled inputs necessary for correctly evaluating the
    /// recipe. Usually only needed for reproducing the build but not evaluated as
    /// part of policy. Since the environment field can greatly vary in structure,
    /// depending on the builder and recipe type, this is of form "Any".
    #[prost(message, repeated, tag = "5")]
    pub environment: ::prost::alloc::vec::Vec<::prost_wkt_types::Any>,
}
...
pub struct Metadata {
    ...
    pub build_started_on: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The timestamp of when the build completed.
    #[prost(message, optional, tag = "3")]
    pub build_finished_on: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Indicates that the builder claims certain fields in this message to be
    /// complete.
...
pub mod slsa_provenance {
    ...
    pub struct SlsaRecipe {
        ...
        #[prost(message, optional, tag = "4")]
        pub arguments: ::core::option::Option<::prost_wkt_types::Any>,
        ...
        pub environment: ::core::option::Option<::prost_wkt_types::Any>,
    }
    /// Indicates that the builder claims certain fields in this message to be
    /// complete.
    #[derive(serde::Serialize, serde::Deserialize)]
...
pub struct SlsaProvenanceZeroTwo {
    ...
    #[prost(message, optional, tag = "4")]
    pub build_config: ::core::option::Option<::prost_wkt_types::Struct>,
    #[prost(message, optional, tag = "5")]
...
pub mod slsa_provenance_zero_two {
    ...
    pub struct SlsaInvocation {
        ...
        #[prost(message, optional, tag = "3")]
        pub environment: ::core::option::Option<::prost_wkt_types::Struct>,
    }
...
pub mod in_toto_slsa_provenance_v1 {
    ...
    pub struct BuildDefinition {
        ...
        pub build_type: ::prost::alloc::string::String,
        #[prost(message, optional, tag = "2")]
        pub external_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
        #[prost(message, optional, tag = "3")]
        pub internal_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
        #[prost(message, repeated, tag = "4")]
    ...
    pub struct BuildMetadata {
        ...
        #[prost(message, optional, tag = "2")]
        pub started_on: ::core::option::Option<::prost_wkt_types::Timestamp>,
        #[prost(message, optional, tag = "3")]
        pub finished_on: ::core::option::Option<::prost_wkt_types::Timestamp>,
    }
}
...
pub struct DeploymentOccurrence {
    ...
    #[prost(message, optional, tag = "3")]
    pub undeploy_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct DiscoveryOccurrence {
    ...
    #[prost(message, optional, tag = "5")]
    pub last_scan_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The time occurrences related to this discovery occurrence were archived.
    #[prost(message, optional, tag = "6")]
    pub archive_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct WindowsUpdate {
    ...
    #[prost(message, optional, tag = "7")]
    pub last_published_timestamp: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct VulnerabilityNote {
    ...
    /// security tracker.
    #[prost(message, optional, tag = "6")]
    pub source_update_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
