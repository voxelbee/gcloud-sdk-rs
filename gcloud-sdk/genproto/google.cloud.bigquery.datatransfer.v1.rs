...
pub struct TransferConfig {
    ...
    pub next_run_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct EncryptionConfiguration {
    ...
    #[prost(message, optional, tag = "1")]
    pub kms_key_name: ::core::option::Option<
...
pub struct TransferMessage {
    ...
    #[prost(message, optional, tag = "1")]
    pub message_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Message severity.
...
pub struct DataSource {
    ...
    #[prost(message, optional, tag = "18")]
    pub minimum_schedule_interval: ::core::option::Option<::prost_wkt_types::Duration>,
}
...
pub mod start_manual_transfer_runs_request {
    ...
    pub enum Time {
        ...
        /// values.
        #[prost(message, tag = "4")]
        RequestedRunTime(::prost_wkt_types::Timestamp),
    }
}
