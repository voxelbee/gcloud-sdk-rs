...
pub mod kubernetes_config {
    ...
    pub struct GatewayServiceMesh {
        ...
        /// no wait time.
        #[prost(message, optional, tag = "4")]
        pub route_update_wait_time: ::core::option::Option<::prost_wkt_types::Duration>,
        ...
        /// cutback time.
        #[prost(message, optional, tag = "5")]
        pub stable_cutback_duration: ::core::option::Option<::prost_wkt_types::Duration>,
    }
...
pub struct ExecutionConfig {
    ...
    /// 1h is used.
    #[prost(message, optional, tag = "7")]
    pub execution_timeout: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct Release {
    ...
    #[prost(message, optional, tag = "7")]
    pub render_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. Time at which the render completed.
    #[prost(message, optional, tag = "8")]
    pub render_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod release {
    ...
    pub struct SkaffoldSupportedCondition {
        ...
        /// maintenance mode.
        #[prost(message, optional, tag = "3")]
        pub maintenance_mode_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
        /// The time at which this release's version of Skaffold will no longer be
        /// supported.
        #[prost(message, optional, tag = "4")]
        pub support_expiration_time: ::core::option::Option<
...
pub struct Rollout {
    ...
    #[prost(message, optional, tag = "7")]
    pub approve_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. Time at which the `Rollout` was enqueued.
    #[prost(message, optional, tag = "8")]
    pub enqueue_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. Time at which the `Rollout` started deploying.
    #[prost(message, optional, tag = "9")]
    pub deploy_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. Time at which the `Rollout` finished deploying.
    #[prost(message, optional, tag = "10")]
    pub deploy_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct SkaffoldVersion {
    ...
    #[prost(message, optional, tag = "4")]
    pub support_expiration_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct PromoteReleaseRule {
    ...
    /// the next target.
    #[prost(message, optional, tag = "2")]
    pub wait: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct AutomationRun {
    ...
    pub wait_until_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
