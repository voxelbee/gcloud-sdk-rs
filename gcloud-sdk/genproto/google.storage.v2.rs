...
pub mod bucket {
    ...
    pub mod iam_config {
        ...
        pub struct UniformBucketLevelAccess {
            ...
            /// afterward.
            #[prost(message, optional, tag = "2")]
            pub lock_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
        }
    }
    ...
    pub struct RetentionPolicy {
        ...
        #[prost(message, optional, tag = "4")]
        pub retention_duration: ::core::option::Option<::prost_wkt_types::Duration>,
    }
...
pub struct Object {
    ...
    #[prost(message, optional, tag = "19")]
    pub update_storage_class_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    /// temporary hold).
    #[prost(message, optional, tag = "21")]
    pub retention_expire_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    #[prost(message, optional, tag = "28")]
    pub soft_delete_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    #[prost(message, optional, tag = "29")]
    pub hard_delete_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
/// An access-control entry.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
