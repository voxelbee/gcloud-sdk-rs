...
pub struct Device {
    ...
    pub last_heartbeat_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// \[Output only\] The last time a telemetry event was received. Timestamps are
    /// periodically collected and written to storage; they may be stale by a few
    /// minutes.
    #[prost(message, optional, tag = "8")]
    pub last_event_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// \[Output only\] The last time a state event was received. Timestamps are
    /// periodically collected and written to storage; they may be stale by a few
    /// minutes.
    #[prost(message, optional, tag = "20")]
    pub last_state_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// \[Output only\] The last time a cloud-to-device config version acknowledgment
    /// was received from the device. This field is only for configurations
    /// sent through MQTT.
    #[prost(message, optional, tag = "14")]
    pub last_config_ack_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// \[Output only\] The last time a cloud-to-device config version was sent to
    /// the device.
    #[prost(message, optional, tag = "18")]
    pub last_config_send_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    pub last_error_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct GatewayConfig {
    ...
    pub last_accessed_gateway_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct X509CertificateDetails {
    ...
    #[prost(message, optional, tag = "4")]
    pub expiry_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct DeviceConfig {
    ...
    pub cloud_update_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    #[prost(message, optional, tag = "3")]
    pub device_ack_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
