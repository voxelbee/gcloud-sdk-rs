...
pub mod answer {
    ...
    pub mod reference {
        ...
        pub struct UnstructuredDocumentInfo {
            ...
            pub struct_data: ::core::option::Option<::prost_wkt_types::Struct>,
        }
...
pub struct Chunk {
    ...
    #[prost(message, optional, tag = "4")]
    pub derived_struct_data: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub struct Document {
    ...
    pub index_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod document {
    ...
    pub enum Data {
        ...
        /// `INVALID_ARGUMENT` error is thrown.
        #[prost(message, tag = "4")]
        StructData(::prost_wkt_types::Struct),
...
pub struct MediaInfo {
    ...
    /// should be set to 90.
    #[prost(message, optional, tag = "1")]
    pub media_progress_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct CustomTuningModel {
    ...
    #[prost(message, optional, tag = "6")]
    pub training_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub mod schema {
    ...
    pub enum Schema {
        ...
        #[prost(message, tag = "2")]
        StructSchema(::prost_wkt_types::Struct),
...
pub struct Project {
    ...
    /// use.
    #[prost(message, optional, tag = "3")]
    pub provision_completion_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod project {
    ...
    pub struct ServiceTerms {
        ...
        /// of service.
        #[prost(message, optional, tag = "6")]
        pub decline_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    }
