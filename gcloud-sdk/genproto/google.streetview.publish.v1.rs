...
pub struct PhotoSequence {
    ...
    /// video or XDM file.
    #[prost(message, optional, tag = "4")]
    pub capture_time_override: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct GpsDataGapFailureDetails {
    ...
    #[prost(message, optional, tag = "1")]
    pub gap_duration: ::core::option::Option<::prost_wkt_types::Duration>,
    /// Relative time (from the start of the video stream) when the gap started.
    #[prost(message, optional, tag = "2")]
    pub gap_start_time: ::core::option::Option<::prost_wkt_types::Duration>,
}
...
pub struct NoOverlapGpsFailureDetails {
    ...
    #[prost(message, optional, tag = "1")]
    pub gps_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Time of last recorded GPS point.
    #[prost(message, optional, tag = "2")]
    pub gps_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Start time of video.
    #[prost(message, optional, tag = "3")]
    pub video_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// End time of video.
    #[prost(message, optional, tag = "4")]
    pub video_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
