...
pub mod key_range {
    ...
    pub enum StartKeyType {
        ...
        #[prost(message, tag = "1")]
        StartClosed(::prost_wkt_types::ListValue),
        /// If the start is open, then the range excludes rows whose first
        /// `len(start_open)` key columns exactly match `start_open`.
        #[prost(message, tag = "2")]
        StartOpen(::prost_wkt_types::ListValue),
    }
    /// The end key must be provided. It can be either closed or open.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[allow(clippy::derive_partial_eq_without_eq)]
    ...
    pub enum EndKeyType {
        ...
        #[prost(message, tag = "3")]
        EndClosed(::prost_wkt_types::ListValue),
        /// If the end is open, then the range excludes rows whose first
        /// `len(end_open)` key columns exactly match `end_open`.
        #[prost(message, tag = "4")]
        EndOpen(::prost_wkt_types::ListValue),
    }
}
...
pub struct KeySet {
    ...
    pub keys: ::prost::alloc::vec::Vec<::prost_wkt_types::ListValue>,
...
pub mod mutation {
    ...
    pub struct Write {
        ...
        pub values: ::prost::alloc::vec::Vec<::prost_wkt_types::ListValue>,
    }
...
pub struct PlanNode {
    ...
    pub execution_stats: ::core::option::Option<::prost_wkt_types::Struct>,
}
...
pub mod transaction_options {
    ...
    pub mod read_only {
        ...
        pub enum TimestampBound {
            ...
            #[prost(message, tag = "2")]
            MinReadTimestamp(::prost_wkt_types::Timestamp),
            ...
            /// transactions.
            #[prost(message, tag = "3")]
            MaxStaleness(::prost_wkt_types::Duration),
            ...
            /// Example: `"2014-10-02T15:01:23.045123456Z"`.
            #[prost(message, tag = "4")]
            ReadTimestamp(::prost_wkt_types::Timestamp),
            ...
            #[prost(message, tag = "5")]
            ExactStaleness(::prost_wkt_types::Duration),
        }
    }
    /// Required. The type of transaction.
    #[derive(serde::Serialize, serde::Deserialize)]
...
pub struct Transaction {
    ...
    /// Example: `"2014-10-02T15:01:23.045123456Z"`.
    #[prost(message, optional, tag = "2")]
    pub read_timestamp: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct ResultSet {
    ...
    /// [here][google.spanner.v1.TypeCode].
    #[prost(message, repeated, tag = "2")]
    pub rows: ::prost::alloc::vec::Vec<::prost_wkt_types::ListValue>,
...
pub struct PartialResultSet {
    ...
    #[prost(message, repeated, tag = "2")]
    pub values: ::prost::alloc::vec::Vec<::prost_wkt_types::Value>,
...
pub struct ResultSetStats {
    ...
    ///      }
    #[prost(message, optional, tag = "2")]
    pub query_stats: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub struct Session {
    ...
    pub approximate_last_use_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct ExecuteSqlRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub params: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub struct CommitRequest {
    ...
    pub max_commit_delay: ::core::option::Option<::prost_wkt_types::Duration>,
    /// Common options for this request.
    #[prost(message, optional, tag = "6")]
    pub request_options: ::core::option::Option<RequestOptions>,
