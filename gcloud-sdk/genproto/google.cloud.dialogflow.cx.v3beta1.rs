...
pub mod advanced_settings {
    ...
    pub struct SpeechSettings {
        ...
        #[prost(message, optional, tag = "2")]
        pub no_speech_timeout: ::core::option::Option<::prost_wkt_types::Duration>,
    ...
    pub struct DtmfSettings {
        ...
        #[prost(message, optional, tag = "6")]
        pub interdigit_timeout_duration: ::core::option::Option<
...
pub struct SpeechWordInfo {
    ...
    #[prost(message, optional, tag = "2")]
    pub end_offset: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct BargeInConfig {
    ...
    /// audio.
    #[prost(message, optional, tag = "1")]
    pub no_barge_in_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct ToolCall {
    ...
    #[prost(message, optional, tag = "3")]
    pub input_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
}
...
pub mod tool_call_result {
    ...
    pub enum Result {
        ...
        #[prost(message, tag = "4")]
        OutputParameters(::prost_wkt_types::Struct),
    }
}
...
pub mod response_message {
    ...
    pub enum Message {
        ...
        #[prost(message, tag = "2")]
        Payload(::prost_wkt_types::Struct),
...
pub mod form {
    ...
    pub struct Parameter {
        ...
        #[prost(message, optional, tag = "9")]
        pub default_value: ::core::option::Option<::prost_wkt_types::Value>,
...
pub mod agent {
    ...
    pub struct PersonalizationSettings {
        ...
        #[prost(message, optional, tag = "1")]
        pub default_end_user_metadata: ::core::option::Option<::prost_wkt_types::Struct>,
    }
    /// The resource to start the conversations with for the agent.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[allow(clippy::derive_partial_eq_without_eq)]
...
pub struct PlaybookInput {
    ...
    #[prost(message, optional, tag = "3")]
    pub action_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
}
...
pub struct ToolUse {
    ...
    /// Optional. A list of input parameters for the action.
    #[prost(message, optional, tag = "5")]
    pub input_action_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
    /// Optional. A list of output parameters generated by the action.
    #[prost(message, optional, tag = "6")]
    pub output_action_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
}
...
pub struct CloudConversationDebuggingInfo {
    ...
    #[prost(message, optional, tag = "2")]
    pub result_end_time_offset: ::core::option::Option<::prost_wkt_types::Duration>,
    /// Duration of first audio chunk.
    #[prost(message, optional, tag = "3")]
    pub first_audio_duration: ::core::option::Option<::prost_wkt_types::Duration>,
    ...
    pub dtmf_partial_results_times: ::prost::alloc::vec::Vec<
        ::prost_wkt_types::Duration,
    >,
    /// Time offsets of the DTMF final results relative to the beginning of
    /// the stream.
    #[prost(message, repeated, tag = "13")]
    pub dtmf_final_results_times: ::prost::alloc::vec::Vec<::prost_wkt_types::Duration>,
    ...
    pub endpointing_timeout: ::core::option::Option<::prost_wkt_types::Duration>,
    /// Whether the streaming terminates with an injected text query.
    #[prost(bool, tag = "16")]
    pub is_input_text: bool,
    /// Client half close time in terms of input audio duration.
    #[prost(message, optional, tag = "17")]
    pub client_half_close_time_offset: ::core::option::Option<
        ::prost_wkt_types::Duration,
    >,
...
pub struct StreamingRecognitionResult {
    ...
    /// `TRANSCRIPT`.
    #[prost(message, optional, tag = "8")]
    pub speech_end_offset: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct QueryParameters {
    ...
    /// use parameter value.
    #[prost(message, optional, tag = "5")]
    pub parameters: ::core::option::Option<::prost_wkt_types::Struct>,
    ...
    pub session_ttl: ::core::option::Option<::prost_wkt_types::Duration>,
    ...
    /// ```
    #[prost(message, optional, tag = "18")]
    pub end_user_metadata: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub struct QueryResult {
    ...
    pub webhook_latencies: ::prost::alloc::vec::Vec<::prost_wkt_types::Duration>,
    ...
    #[prost(message, repeated, tag = "6")]
    pub webhook_payloads: ::prost::alloc::vec::Vec<::prost_wkt_types::Struct>,
    ...
    #[prost(message, optional, tag = "10")]
    pub diagnostic_info: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub struct TestCaseResult {
    ...
    #[prost(message, optional, tag = "5")]
    pub test_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub mod conversation_turn {
    ...
    pub struct UserInput {
        ...
        /// detection.
        #[prost(message, optional, tag = "2")]
        pub injected_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
    ...
    pub struct VirtualAgentOutput {
        ...
        #[prost(message, optional, tag = "4")]
        pub session_parameters: ::core::option::Option<::prost_wkt_types::Struct>,
...
pub mod webhook_request {
    ...
    pub mod intent_info {
        ...
        pub struct IntentParameterValue {
            ...
            /// utterance.
            #[prost(message, optional, tag = "2")]
            pub resolved_value: ::core::option::Option<::prost_wkt_types::Value>,
        }
    }
...
pub struct ContinuousTestResult {
    ...
    #[prost(message, optional, tag = "4")]
    pub run_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub mod conversation {
    ...
    pub struct Metrics {
        ...
        #[prost(message, optional, tag = "2")]
        pub input_audio_duration: ::core::option::Option<::prost_wkt_types::Duration>,
        /// Duration of all the output's audio in the conversation.
        #[prost(message, optional, tag = "3")]
        pub output_audio_duration: ::core::option::Option<::prost_wkt_types::Duration>,
        /// Maximum latency of the
        /// [Webhook][google.cloud.dialogflow.cx.v3beta1.Webhook] calls in the
        /// conversation.
        #[prost(message, optional, tag = "4")]
        pub max_webhook_latency: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct Experiment {
    ...
    #[prost(message, optional, tag = "11")]
    pub experiment_length: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub mod tool {
    ...
    pub struct FunctionTool {
        ...
        #[prost(message, optional, tag = "1")]
        pub input_schema: ::core::option::Option<::prost_wkt_types::Struct>,
        /// Optional. The JSON schema is encapsulated in a
        ...
        #[prost(message, optional, tag = "2")]
        pub output_schema: ::core::option::Option<::prost_wkt_types::Struct>,
    }
...
pub struct CompareVersionsResponse {
    ...
    #[prost(message, optional, tag = "3")]
    pub compare_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
/// Generated client implementations.
