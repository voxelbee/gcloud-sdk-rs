...
pub struct Backup {
    ...
    pub version_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Required for the
    /// [CreateBackup][google.spanner.admin.database.v1.DatabaseAdmin.CreateBackup]
    ...
    pub max_expire_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct CreateBackupMetadata {
    ...
    #[prost(message, optional, tag = "4")]
    pub cancel_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
/// The request for
...
pub struct UpdateDatabaseDdlMetadata {
    ...
    pub commit_timestamps: ::prost::alloc::vec::Vec<::prost_wkt_types::Timestamp>,
