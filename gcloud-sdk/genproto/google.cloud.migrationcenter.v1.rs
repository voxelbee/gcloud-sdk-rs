...
pub struct ErrorFrame {
    ...
    #[prost(message, optional, tag = "4")]
    pub ingestion_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct AssetFrame {
    ...
    pub report_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Labels as key value pairs.
...
pub struct GuestRuntimeDetails {
    ...
    #[prost(message, optional, tag = "4")]
    pub last_boot_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct RuntimeNetworkInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub scan_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Network connections.
    #[prost(message, optional, tag = "2")]
...
pub struct GuestInstalledApplication {
    ...
    #[prost(message, optional, tag = "3")]
    pub install_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Source path.
    #[prost(string, tag = "4")]
...
pub struct PerformanceSample {
    ...
    #[prost(message, optional, tag = "1")]
    pub sample_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Memory usage sample.
    #[prost(message, optional, tag = "2")]
...
pub struct UploadFileInfo {
    ...
    #[prost(message, optional, tag = "3")]
    pub uri_expiration_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
