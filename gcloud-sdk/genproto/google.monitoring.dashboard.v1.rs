...
pub mod pie_chart {
    ...
    pub struct PieChartDataSet {
        ...
        #[prost(message, optional, tag = "3")]
        pub min_alignment_period: ::core::option::Option<::prost_wkt_types::Duration>,
    }
...
pub mod scorecard {
    ...
    pub enum DataView {
        ...
        #[prost(message, tag = "7")]
        BlankView(::prost_wkt_types::Empty),
    }
}
...
pub struct XyChart {
    ...
    #[prost(message, optional, tag = "4")]
    pub timeshift_duration: ::core::option::Option<::prost_wkt_types::Duration>,
