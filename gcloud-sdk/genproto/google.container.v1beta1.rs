...
pub struct NodeKubeletConfig {
    ...
    pub cpu_cfs_quota: ::core::option::Option<super::super::protobuf::BoolValue>,
...
pub mod host_maintenance_policy {
    ...
    pub struct OpportunisticMaintenanceStrategy {
        ...
        #[prost(message, optional, tag = "1")]
        pub node_idle_time_window: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct BlueGreenSettings {
    ...
    /// will be cleaned up.
    #[prost(message, optional, tag = "2")]
    pub node_pool_soak_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub mod blue_green_settings {
    ...
    pub struct StandardRolloutPolicy {
        ...
        #[prost(message, optional, tag = "3")]
        pub batch_soak_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct WorkloadAltsConfig {
    ...
    /// must be non-empty).
    #[prost(message, optional, tag = "1")]
    pub enable_alts: ::core::option::Option<super::super::protobuf::BoolValue>,
}
...
pub struct WorkloadCertificates {
    ...
    /// must be non-empty).
    #[prost(message, optional, tag = "1")]
    pub enable_certificates: ::core::option::Option<super::super::protobuf::BoolValue>,
}
/// Configuration for issuance of mTLS keys and certificates to Kubernetes pods.
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
...
pub struct AutopilotCompatibilityIssue {
    ...
    #[prost(message, optional, tag = "1")]
    pub last_observation: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct UpgradeEvent {
    ...
    #[prost(message, optional, tag = "3")]
    pub operation_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
