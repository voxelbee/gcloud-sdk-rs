...
pub struct PersonalProtectiveEquipmentDetectionOutput {
    ...
    pub current_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct ImageObjectDetectionPredictionResult {
    ...
    pub bboxes: ::prost::alloc::vec::Vec<::prost_wkt_types::ListValue>,
}
...
pub struct VideoActionRecognitionPredictionResult {
    ...
    #[prost(message, optional, tag = "1")]
    pub segment_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    #[prost(message, optional, tag = "2")]
    pub segment_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod occupancy_counting_prediction_result {
    ...
    pub struct DwellTimeInfo {
        ...
        #[prost(message, optional, tag = "3")]
        pub dwell_start_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
        /// The end time when a dwelling object has exited in a zone.
        #[prost(message, optional, tag = "4")]
        pub dwell_end_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    }
}
...
pub mod app_platform_cloud_function_request {
    ...
    pub struct StructedInputAnnotation {
        ...
        #[prost(message, optional, tag = "2")]
        pub annotation: ::core::option::Option<::prost_wkt_types::Struct>,
    }
}
...
pub mod application {
    ...
    pub struct ApplicationRuntimeInfo {
        ...
        #[prost(message, optional, tag = "1")]
        pub deploy_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod application_configs {
    ...
    pub struct EventDeliveryConfig {
        ...
        #[prost(message, optional, tag = "2")]
        pub minimal_delivery_interval: ::core::option::Option<
...
pub struct ProcessorConfig {
    ...
    pub experimental_config: ::core::option::Option<::prost_wkt_types::Struct>,
    #[prost(
...
pub struct GstreamerBufferDescriptor {
    ...
    /// PTS of the frame.
    #[prost(message, optional, tag = "3")]
    pub pts_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// DTS of the frame.
    #[prost(message, optional, tag = "4")]
    pub dts_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct ServerMetadata {
    ...
    #[prost(message, optional, tag = "2")]
    pub ingest_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct PacketHeader {
    ...
    #[prost(message, optional, tag = "1")]
    pub capture_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod receive_events_request {
    ...
    pub struct SetupRequest {
        ...
        #[prost(message, optional, tag = "5")]
        pub heartbeat_interval: ::core::option::Option<::prost_wkt_types::Duration>,
        ...
        #[prost(message, optional, tag = "6")]
        pub writes_done_grace_period: ::core::option::Option<
            ::prost_wkt_types::Duration,
        >,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
...
pub struct AcquireLeaseRequest {
    ...
    /// The lease term.
    #[prost(message, optional, tag = "3")]
    pub term: ::core::option::Option<::prost_wkt_types::Duration>,
    /// The lease type.
...
pub struct RequestMetadata {
    ...
    #[prost(message, optional, tag = "6")]
    pub lease_term: ::core::option::Option<::prost_wkt_types::Duration>,
}
...
pub struct Event {
    ...
    /// will be ignored.
    #[prost(message, optional, tag = "7")]
    pub grace_period: ::core::option::Option<::prost_wkt_types::Duration>,
}
...
pub struct Corpus {
    ...
    #[prost(message, optional, tag = "5")]
    pub default_ttl: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub mod annotation_value {
    ...
    pub enum Value {
        ...
        #[prost(message, tag = "8")]
        ProtoAnyValue(::prost_wkt_types::Any),
        ...
        #[prost(message, tag = "10")]
        CustomizedStructDataValue(::prost_wkt_types::Struct),
