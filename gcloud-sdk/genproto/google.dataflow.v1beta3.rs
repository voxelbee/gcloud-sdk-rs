...
pub struct Environment {
    ...
    pub user_agent: ::core::option::Option<::prost_wkt_types::Struct>,
    /// A structure describing which components and their versions of the service
    /// are required in order to run the job.
    #[prost(message, optional, tag = "6")]
    pub version: ::core::option::Option<::prost_wkt_types::Struct>,
    ...
    pub sdk_pipeline_options: ::core::option::Option<::prost_wkt_types::Struct>,
    /// Experimental settings.
    #[prost(message, optional, tag = "9")]
    pub internal_experiments: ::core::option::Option<::prost_wkt_types::Any>,
...
pub struct WorkerPool {
    ...
    pub pool_args: ::core::option::Option<::prost_wkt_types::Any>,
...
pub struct Job {
    ...
    #[prost(message, optional, tag = "8")]
    pub current_state_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub mod display_data {
    ...
    pub enum Value {
        ...
        #[prost(message, tag = "9")]
        DurationValue(::prost_wkt_types::Duration),
...
pub struct Step {
    ...
    #[prost(message, optional, tag = "3")]
    pub properties: ::core::option::Option<::prost_wkt_types::Struct>,
}
...
pub struct MetricUpdate {
    ...
    #[prost(message, optional, tag = "4")]
    pub scalar: ::core::option::Option<::prost_wkt_types::Value>,
    /// Worker-computed aggregate value for the "Mean" aggregation kind.
    /// This holds the sum of the aggregated values and is used in combination
    /// with mean_count below to obtain the actual mean aggregate value.
    /// The only possible value types are Long and Double.
    #[prost(message, optional, tag = "5")]
    pub mean_sum: ::core::option::Option<::prost_wkt_types::Value>,
    /// Worker-computed aggregate value for the "Mean" aggregation kind.
    /// This holds the count of the aggregated values and is used in combination
    /// with mean_sum above to obtain the actual mean aggregate value.
    /// The only possible value type is Long.
    #[prost(message, optional, tag = "6")]
    pub mean_count: ::core::option::Option<::prost_wkt_types::Value>,
    /// Worker-computed aggregate value for the "Set" aggregation kind.  The only
    /// possible value type is a list of Values whose type can be Long, Double,
    /// or String, according to the metric's type.  All Values in the list must
    /// be of the same type.
    #[prost(message, optional, tag = "7")]
    pub set: ::core::option::Option<::prost_wkt_types::Value>,
    /// A struct value describing properties of a distribution of numeric values.
    #[prost(message, optional, tag = "11")]
    pub distribution: ::core::option::Option<::prost_wkt_types::Value>,
    /// A struct value describing properties of a Gauge.
    /// Metrics of gauge type show the value of a metric across time, and is
    /// aggregated based on the newest value.
    #[prost(message, optional, tag = "12")]
    pub gauge: ::core::option::Option<::prost_wkt_types::Value>,
    /// Worker-computed aggregate value for internal use by the Dataflow
    /// service.
    #[prost(message, optional, tag = "8")]
    pub internal: ::core::option::Option<::prost_wkt_types::Value>,
...
pub struct JobMetrics {
    ...
    #[prost(message, optional, tag = "1")]
    pub metric_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
