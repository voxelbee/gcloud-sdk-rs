...
pub struct CaseResponse {
    ...
    pub adjustment_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct UpiTransaction {
    ...
    #[prost(message, optional, tag = "9")]
    pub payload_receipt_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The timestamp at which the payload was sent by the issuer switch.
    #[prost(message, optional, tag = "10")]
    pub payload_sent_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct IssuerParticipant {
    ...
    /// incorrect attempts.
    #[prost(message, optional, tag = "6")]
    pub mpin_locked_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
