...
pub struct TableFieldSchema {
    ...
    pub description: ::core::option::Option<super::super::super::protobuf::StringValue>,
    ...
    pub collation: ::core::option::Option<super::super::super::protobuf::StringValue>,
    /// Optional. A SQL expression to specify the \[default value\]
    /// (<https://cloud.google.com/bigquery/docs/default-values>) for this field.
    #[prost(message, optional, tag = "14")]
    pub default_value_expression: ::core::option::Option<
        super::super::super::protobuf::StringValue,
    >,
...
pub struct Dataset {
    ...
    #[prost(message, optional, tag = "8")]
    pub default_table_expiration_ms: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "14")]
    pub default_partition_expiration_ms: ::core::option::Option<pb::Int64Value>,
    ...
    pub satisfies_pzi: ::core::option::Option<super::super::super::protobuf::BoolValue>,
    ...
    pub is_case_insensitive: ::core::option::Option<
    ...
    pub default_collation: ::core::option::Option<
        super::super::super::protobuf::StringValue,
    >,
    ...
    pub max_time_travel_hours: ::core::option::Option<pb::Int64Value>,
...
pub struct ListDatasetsRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub max_results: ::core::option::Option<pb::UInt32Value>,
...
pub struct UndeleteDatasetRequest {
    ...
    #[prost(message, optional, tag = "3")]
    pub deletion_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
...
pub struct HivePartitioningOptions {
    ...
    /// true will fail.
    #[prost(message, optional, tag = "3")]
    pub require_partition_filter: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
...
pub struct AvroOptions {
    ...
    #[prost(message, optional, tag = "1")]
    pub use_avro_logical_types: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
}
...
pub struct ParquetOptions {
    ...
    #[prost(message, optional, tag = "1")]
    pub enum_as_string: ::core::option::Option<super::super::super::protobuf::BoolValue>,
    /// Optional. Indicates whether to use schema inference specifically for
    /// Parquet LIST logical type.
    #[prost(message, optional, tag = "2")]
    pub enable_list_inference: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
...
pub struct CsvOptions {
    ...
    #[prost(message, optional, tag = "2")]
    pub skip_leading_rows: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "3")]
    pub quote: ::core::option::Option<super::super::super::protobuf::StringValue>,
    /// Optional. Indicates if BigQuery should allow quoted data sections that
    /// contain newline characters in a CSV file. The default value is false.
    #[prost(message, optional, tag = "4")]
    pub allow_quoted_newlines: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    #[prost(message, optional, tag = "5")]
    pub allow_jagged_rows: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    #[prost(message, optional, tag = "7")]
    pub preserve_ascii_control_characters: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    #[prost(message, optional, tag = "8")]
    pub null_marker: ::core::option::Option<super::super::super::protobuf::StringValue>,
}
...
pub struct BigtableColumn {
    ...
    #[prost(message, optional, tag = "1")]
    pub qualifier_encoded: ::core::option::Option<
        super::super::super::protobuf::BytesValue,
    >,
    /// Qualifier string.
    #[prost(message, optional, tag = "2")]
    pub qualifier_string: ::core::option::Option<
        super::super::super::protobuf::StringValue,
    >,
    ...
    /// levels.
    #[prost(message, optional, tag = "6")]
    pub only_read_latest: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
}
...
pub struct BigtableOptions {
    ...
    #[prost(message, optional, tag = "2")]
    pub ignore_unspecified_column_families: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    /// The default value is false.
    #[prost(message, optional, tag = "3")]
    pub read_rowkey_as_string: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    #[prost(message, optional, tag = "4")]
    pub output_column_families_as_json: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
}
...
pub struct ExternalDataConfiguration {
    ...
    #[prost(message, optional, tag = "4")]
    pub max_bad_records: ::core::option::Option<pb::Int32Value>,
    /// Try to detect schema and format options automatically.
    /// Any option specified explicitly will be honored.
    #[prost(message, optional, tag = "5")]
    pub autodetect: ::core::option::Option<super::super::super::protobuf::BoolValue>,
    ...
    #[prost(message, optional, tag = "6")]
    pub ignore_unknown_values: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
...
pub struct QueryParameterValue {
    ...
    #[prost(message, optional, tag = "1")]
    pub value: ::core::option::Option<super::super::super::protobuf::StringValue>,
    ...
    pub alt_struct_values: ::prost::alloc::vec::Vec<::prost_wkt_types::Value>,
}
...
pub struct SystemVariables {
    ...
    #[prost(message, optional, tag = "2")]
    pub values: ::core::option::Option<::prost_wkt_types::Struct>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TimePartitioning {
    ...
    #[prost(message, optional, tag = "2")]
    pub expiration_ms: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "3")]
    pub field: ::core::option::Option<super::super::super::protobuf::StringValue>,
}
///
...
pub struct UserDefinedFunctionResource {
    ...
    /// (gs://bucket/path).
    #[prost(message, optional, tag = "1")]
    pub resource_uri: ::core::option::Option<super::super::super::protobuf::StringValue>,
    ...
    #[prost(message, optional, tag = "2")]
    pub inline_code: ::core::option::Option<super::super::super::protobuf::StringValue>,
}
...
pub struct JobConfigurationQuery {
    ...
    #[prost(message, optional, tag = "10")]
    pub allow_large_results: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    pub use_query_cache: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    pub flatten_results: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    ...
    #[prost(message, optional, tag = "14")]
    pub maximum_bytes_billed: ::core::option::Option<pb::Int64Value>,
    ...
    pub use_legacy_sql: ::core::option::Option<super::super::super::protobuf::BoolValue>,
    ...
    pub create_session: ::core::option::Option<super::super::super::protobuf::BoolValue>,
    ...
    pub continuous: ::core::option::Option<super::super::super::protobuf::BoolValue>,
}
...
pub struct ScriptOptions {
    ...
    #[prost(message, optional, tag = "1")]
    pub statement_timeout_ms: ::core::option::Option<pb::Int64Value>,
    /// Limit on the number of bytes billed per statement. Exceeding this budget
    /// results in an error.
    #[prost(message, optional, tag = "2")]
    pub statement_byte_budget: ::core::option::Option<pb::Int64Value>,
...
pub struct JobConfigurationLoad {
    ...
    ///    Otherwise row N is used to extract column names for the detected schema.
    #[prost(message, optional, tag = "9")]
    pub skip_leading_rows: ::core::option::Option<pb::Int32Value>,
    /// Optional. The character encoding of the data.
    /// The supported values are UTF-8, ISO-8859-1, UTF-16BE, UTF-16LE, UTF-32BE,
    ...
    pub copy_files_only: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
}
...
pub struct JobConfigurationExtract {
    ...
    #[prost(message, optional, tag = "4")]
    pub print_header: ::core::option::Option<super::super::super::protobuf::BoolValue>,
...
pub mod job_configuration_extract {
    ...
    pub struct ModelExtractOptions {
        ...
        #[prost(message, optional, tag = "1")]
        pub trial_id: ::core::option::Option<pb::Int64Value>,
    }
    /// Required. Source reference for the export.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[allow(clippy::derive_partial_eq_without_eq)]
...
pub struct JobConfiguration {
    ...
    #[prost(message, optional, tag = "5")]
    pub dry_run: ::core::option::Option<super::super::super::protobuf::BoolValue>,
    ...
    #[prost(message, optional, tag = "6")]
    pub job_timeout_ms: ::core::option::Option<pb::Int64Value>,
...
pub struct JobReference {
    ...
    #[prost(message, optional, tag = "3")]
    pub location: ::core::option::Option<super::super::super::protobuf::StringValue>,
    /// This field should not be used.
    #[prost(string, repeated, tag = "5")]
...
pub mod model {
    ...
    pub struct RegressionMetrics {
        /// Mean absolute error.
        #[prost(message, optional, tag = "1")]
        pub mean_absolute_error: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Mean squared error.
        #[prost(message, optional, tag = "2")]
        pub mean_squared_error: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Mean squared log error.
        #[prost(message, optional, tag = "3")]
        pub mean_squared_log_error: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Median absolute error.
        #[prost(message, optional, tag = "4")]
        pub median_absolute_error: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// R^2 score. This corresponds to r2_score in ML.EVALUATE.
        #[prost(message, optional, tag = "5")]
        pub r_squared: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
    }
    ...
    pub struct AggregateClassificationMetrics {
        ...
        /// positive prediction. For multiclass this is a macro-averaged metric.
        #[prost(message, optional, tag = "2")]
        pub recall: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Accuracy is the fraction of predictions given the correct label. For
        /// multiclass this is a micro-averaged metric.
        #[prost(message, optional, tag = "3")]
        pub accuracy: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        ...
        #[prost(message, optional, tag = "5")]
        pub f1_score: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Logarithmic Loss. For multiclass this is a macro-averaged metric.
        #[prost(message, optional, tag = "6")]
        pub log_loss: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Area Under a ROC Curve. For multiclass this is a macro-averaged
        /// metric.
        #[prost(message, optional, tag = "7")]
        pub roc_auc: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
    }
    ...
    pub mod binary_classification_metrics {
        ...
        pub struct BinaryConfusionMatrix {
            ...
            #[prost(message, optional, tag = "1")]
            pub positive_class_threshold: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            /// Number of true samples predicted as true.
            #[prost(message, optional, tag = "2")]
            pub true_positives: ::core::option::Option<pb::Int64Value>,
            /// Number of false samples predicted as true.
            #[prost(message, optional, tag = "3")]
            pub false_positives: ::core::option::Option<pb::Int64Value>,
            /// Number of true samples predicted as false.
            #[prost(message, optional, tag = "4")]
            pub true_negatives: ::core::option::Option<pb::Int64Value>,
            /// Number of false samples predicted as false.
            #[prost(message, optional, tag = "5")]
            pub false_negatives: ::core::option::Option<pb::Int64Value>,
    ...
    pub mod multi_class_classification_metrics {
        ...
        pub struct ConfusionMatrix {
            ...
            /// confusion matrix.
            #[prost(message, optional, tag = "1")]
            pub confidence_threshold: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
        ...
        pub mod confusion_matrix {
            ...
            pub struct Entry {
                ...
                #[prost(message, optional, tag = "2")]
                pub item_count: ::core::option::Option<pb::Int64Value>,
            }
    ...
    pub struct ClusteringMetrics {
        /// Davies-Bouldin index.
        #[prost(message, optional, tag = "1")]
        pub davies_bouldin_index: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Mean of squared distances between each sample to its cluster centroid.
        #[prost(message, optional, tag = "2")]
        pub mean_squared_distance: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
    ...
    pub mod clustering_metrics {
        ...
        pub struct Cluster {
            ...
            #[prost(message, optional, tag = "3")]
            pub count: ::core::option::Option<pb::Int64Value>,
        }
    ...
    pub struct RankingMetrics {
        ...
        #[prost(message, optional, tag = "1")]
        pub mean_average_precision: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        ...
        /// original ratings.
        #[prost(message, optional, tag = "3")]
        pub normalized_discounted_cumulative_gain: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Determines the goodness of a ranking by computing the percentile rank
        /// from the predicted confidence and dividing it by the original rank.
        #[prost(message, optional, tag = "4")]
        pub average_rank: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
    }
    ...
    pub mod arima_forecasting_metrics {
        ...
        pub struct ArimaSingleModelForecastingMetrics {
            ...
            pub has_drift: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
    ...
    pub struct DimensionalityReductionMetrics {
        ...
        /// components.
        #[prost(message, optional, tag = "1")]
        pub total_explained_variance_ratio: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
    }
    ...
    pub struct ArimaOrder {
        ...
        #[prost(message, optional, tag = "1")]
        pub p: ::core::option::Option<pb::Int64Value>,
        /// Order of the differencing part.
        #[prost(message, optional, tag = "2")]
        pub d: ::core::option::Option<pb::Int64Value>,
        /// Order of the moving-average part.
        #[prost(message, optional, tag = "3")]
        pub q: ::core::option::Option<pb::Int64Value>,
    }
    ...
    pub struct ArimaFittingMetrics {
        /// Log-likelihood.
        #[prost(message, optional, tag = "1")]
        pub log_likelihood: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// AIC.
        #[prost(message, optional, tag = "2")]
        pub aic: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
        /// Variance.
        #[prost(message, optional, tag = "3")]
        pub variance: ::core::option::Option<
            super::super::super::super::protobuf::DoubleValue,
        >,
    }
    ...
    pub mod training_run {
        ...
        pub struct TrainingOptions {
            ...
            #[prost(message, optional, tag = "4")]
            pub l1_regularization: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            /// L2 regularization coefficient.
            #[prost(message, optional, tag = "5")]
            pub l2_regularization: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            ...
            /// algorithms.
            #[prost(message, optional, tag = "6")]
            pub min_relative_progress: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            /// Whether to train a model from the last checkpoint.
            #[prost(message, optional, tag = "7")]
            pub warm_start: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            ...
            /// training algorithms.
            #[prost(message, optional, tag = "8")]
            pub early_stop: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            ...
            #[prost(message, optional, tag = "26")]
            pub dropout: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            ...
            #[prost(message, optional, tag = "29")]
            pub min_split_loss: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            ...
            pub num_parallel_tree: ::core::option::Option<pb::Int64Value>,
            ...
            pub min_tree_child_weight: ::core::option::Option<pb::Int64Value>,
            /// Subsample ratio of columns when constructing each tree for boosted tree
            /// models.
            #[prost(message, optional, tag = "65")]
            pub colsample_bytree: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            /// Subsample ratio of columns for each level for boosted tree models.
            #[prost(message, optional, tag = "66")]
            pub colsample_bylevel: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            /// Subsample ratio of columns for each node(split) for boosted tree
            /// models.
            #[prost(message, optional, tag = "67")]
            pub colsample_bynode: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            ...
            /// specified.
            #[prost(message, optional, tag = "32")]
            pub wals_alpha: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            ...
            #[prost(message, optional, tag = "37")]
            pub auto_arima: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            ...
            pub calculate_p_values: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            /// Include drift when fitting an ARIMA model.
            #[prost(message, optional, tag = "41")]
            pub include_drift: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            ...
            pub decompose_time_series: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            /// If true, clean spikes and dips in the input time series.
            #[prost(message, optional, tag = "52")]
            pub clean_spikes_and_dips: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            /// If true, detect step changes and make data adjustment in the input time
            /// series.
            #[prost(message, optional, tag = "53")]
            pub adjust_step_changes: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            /// If true, enable global explanation during training.
            #[prost(message, optional, tag = "55")]
            pub enable_global_explain: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            ...
            pub approx_global_feature_contrib: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            /// Whether the model should include intercept during model training.
            #[prost(message, optional, tag = "85")]
            pub fit_intercept: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            ...
            pub scale_features: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            /// The solver for PCA.
            #[prost(
            ...
            pub auto_class_weights: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
            ...
            pub standardize_features: ::core::option::Option<
                super::super::super::super::super::protobuf::BoolValue,
            >,
        ...
        pub struct IterationResult {
            ...
            #[prost(message, optional, tag = "1")]
            pub index: ::core::option::Option<pb::Int32Value>,
            /// Time taken to run the iteration in milliseconds.
            #[prost(message, optional, tag = "4")]
            pub duration_ms: ::core::option::Option<pb::Int64Value>,
            /// Loss computed on the training data at the end of iteration.
            #[prost(message, optional, tag = "5")]
            pub training_loss: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
            /// Loss computed on the eval data at the end of iteration.
            #[prost(message, optional, tag = "6")]
            pub eval_loss: ::core::option::Option<
                super::super::super::super::super::protobuf::DoubleValue,
            >,
        ...
        pub mod iteration_result {
            ...
            pub struct ClusterInfo {
                ...
                #[prost(message, optional, tag = "3")]
                pub cluster_size: ::core::option::Option<pb::Int64Value>,
            }
            ...
            pub struct PrincipalComponentInfo {
                ...
                #[prost(message, optional, tag = "1")]
                pub principal_component_id: ::core::option::Option<pb::Int64Value>,
    ...
    pub mod int_hparam_search_space {
        ...
        pub struct IntRange {
            ...
            #[prost(message, optional, tag = "1")]
            pub min: ::core::option::Option<pb::Int64Value>,
            /// Max value of the int parameter.
            #[prost(message, optional, tag = "2")]
            pub max: ::core::option::Option<pb::Int64Value>,
        }
        ...
        pub struct IntCandidates {
            ...
            #[prost(message, repeated, tag = "1")]
            pub candidates: ::prost::alloc::vec::Vec<pb::Int64Value>,
        }
        /// Search space.
        #[derive(serde::Serialize, serde::Deserialize)]
        #[allow(clippy::derive_partial_eq_without_eq)]
...
pub struct ExplainQueryStage {
    ...
    #[prost(message, optional, tag = "2")]
    pub id: ::core::option::Option<pb::Int64Value>,
    ...
    /// scheduled.
    #[prost(message, optional, tag = "6")]
    pub wait_ratio_avg: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the average shard spent waiting to be scheduled.
    #[prost(message, optional, tag = "7")]
    pub wait_ms_avg: ::core::option::Option<pb::Int64Value>,
    /// Relative amount of time the slowest shard spent waiting to be
    /// scheduled.
    #[prost(message, optional, tag = "8")]
    pub wait_ratio_max: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the slowest shard spent waiting to be scheduled.
    #[prost(message, optional, tag = "9")]
    pub wait_ms_max: ::core::option::Option<pb::Int64Value>,
    /// Relative amount of time the average shard spent reading input.
    #[prost(message, optional, tag = "10")]
    pub read_ratio_avg: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the average shard spent reading input.
    #[prost(message, optional, tag = "11")]
    pub read_ms_avg: ::core::option::Option<pb::Int64Value>,
    /// Relative amount of time the slowest shard spent reading input.
    #[prost(message, optional, tag = "12")]
    pub read_ratio_max: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the slowest shard spent reading input.
    #[prost(message, optional, tag = "13")]
    pub read_ms_max: ::core::option::Option<pb::Int64Value>,
    /// Relative amount of time the average shard spent on CPU-bound tasks.
    #[prost(message, optional, tag = "14")]
    pub compute_ratio_avg: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the average shard spent on CPU-bound tasks.
    #[prost(message, optional, tag = "15")]
    pub compute_ms_avg: ::core::option::Option<pb::Int64Value>,
    /// Relative amount of time the slowest shard spent on CPU-bound tasks.
    #[prost(message, optional, tag = "16")]
    pub compute_ratio_max: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the slowest shard spent on CPU-bound tasks.
    #[prost(message, optional, tag = "17")]
    pub compute_ms_max: ::core::option::Option<pb::Int64Value>,
    /// Relative amount of time the average shard spent on writing output.
    #[prost(message, optional, tag = "18")]
    pub write_ratio_avg: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the average shard spent on writing output.
    #[prost(message, optional, tag = "19")]
    pub write_ms_avg: ::core::option::Option<pb::Int64Value>,
    /// Relative amount of time the slowest shard spent on writing output.
    #[prost(message, optional, tag = "20")]
    pub write_ratio_max: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
    /// Milliseconds the slowest shard spent on writing output.
    #[prost(message, optional, tag = "21")]
    pub write_ms_max: ::core::option::Option<pb::Int64Value>,
    /// Total number of bytes written to shuffle.
    #[prost(message, optional, tag = "22")]
    pub shuffle_output_bytes: ::core::option::Option<pb::Int64Value>,
    /// Total number of bytes written to shuffle and spilled to disk.
    #[prost(message, optional, tag = "23")]
    pub shuffle_output_bytes_spilled: ::core::option::Option<pb::Int64Value>,
    /// Number of records read into the stage.
    #[prost(message, optional, tag = "24")]
    pub records_read: ::core::option::Option<pb::Int64Value>,
    /// Number of records written by the stage.
    #[prost(message, optional, tag = "25")]
    pub records_written: ::core::option::Option<pb::Int64Value>,
    /// Number of parallel input segments to be processed
    #[prost(message, optional, tag = "26")]
    pub parallel_inputs: ::core::option::Option<pb::Int64Value>,
    /// Number of parallel input segments completed.
    #[prost(message, optional, tag = "27")]
    pub completed_parallel_inputs: ::core::option::Option<pb::Int64Value>,
    ...
    pub slot_ms: ::core::option::Option<pb::Int64Value>,
...
pub struct QueryTimelineSample {
    ...
    #[prost(message, optional, tag = "1")]
    pub elapsed_ms: ::core::option::Option<pb::Int64Value>,
    /// Cumulative slot-ms consumed by the query.
    #[prost(message, optional, tag = "2")]
    pub total_slot_ms: ::core::option::Option<pb::Int64Value>,
    /// Total units of work remaining for the query. This number can be revised
    /// (increased or decreased) while the query is running.
    #[prost(message, optional, tag = "3")]
    pub pending_units: ::core::option::Option<pb::Int64Value>,
    /// Total parallel units of work completed by this query.
    #[prost(message, optional, tag = "4")]
    pub completed_units: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "5")]
    pub active_units: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "7")]
    pub estimated_runnable_units: ::core::option::Option<pb::Int64Value>,
}
...
pub struct ExternalServiceCost {
    ...
    #[prost(message, optional, tag = "2")]
    pub bytes_processed: ::core::option::Option<pb::Int64Value>,
    /// External service cost in terms of bigquery bytes billed.
    #[prost(message, optional, tag = "3")]
    pub bytes_billed: ::core::option::Option<pb::Int64Value>,
...
pub struct ExportDataStatistics {
    ...
    /// statement only.
    #[prost(message, optional, tag = "1")]
    pub file_count: ::core::option::Option<pb::Int64Value>,
    /// \[Alpha\] Number of destination rows generated in case of EXPORT DATA
    /// statement only.
    #[prost(message, optional, tag = "2")]
    pub row_count: ::core::option::Option<pb::Int64Value>,
}
...
pub struct QueryInfo {
    ...
    #[prost(message, optional, tag = "2")]
    pub optimization_details: ::core::option::Option<::prost_wkt_types::Struct>,
}
...
pub struct LoadQueryStatistics {
    ...
    /// input data.
    #[prost(message, optional, tag = "5")]
    pub bad_records: ::core::option::Option<pb::Int64Value>,
}
...
pub struct JobStatistics2 {
    ...
    #[prost(message, optional, tag = "2")]
    pub estimated_bytes_processed: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "4")]
    pub total_partitions_processed: ::core::option::Option<pb::Int64Value>,
    /// Output only. Total bytes processed for the job.
    #[prost(message, optional, tag = "5")]
    pub total_bytes_processed: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "6")]
    pub total_bytes_billed: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "7")]
    pub billing_tier: ::core::option::Option<pb::Int32Value>,
    /// Output only. Slot-milliseconds for the job.
    #[prost(message, optional, tag = "8")]
    pub total_slot_ms: ::core::option::Option<pb::Int64Value>,
    /// Output only. Whether the query result was fetched from the query cache.
    #[prost(message, optional, tag = "9")]
    pub cache_hit: ::core::option::Option<super::super::super::protobuf::BoolValue>,
    ...
    #[prost(message, optional, tag = "12")]
    pub num_dml_affected_rows: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "27")]
    pub ddl_affected_row_access_policy_count: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "41")]
    pub transferred_bytes: ::core::option::Option<pb::Int64Value>,
...
pub struct JobStatistics4 {
    ...
    #[prost(message, optional, tag = "2")]
    pub input_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. Describes a timeline of job execution.
    #[prost(message, repeated, tag = "3")]
    pub timeline: ::prost::alloc::vec::Vec<QueryTimelineSample>,
}
...
pub struct CopyJobStatistics {
    ...
    #[prost(message, optional, tag = "1")]
    pub copied_rows: ::core::option::Option<pb::Int64Value>,
    /// Output only. Number of logical bytes copied to the destination table.
    #[prost(message, optional, tag = "2")]
    pub copied_logical_bytes: ::core::option::Option<pb::Int64Value>,
}
...
pub struct JobStatistics {
    ...
    /// EXTRACT jobs.
    #[prost(message, optional, tag = "5")]
    pub completion_ratio: ::core::option::Option<
        super::super::super::protobuf::DoubleValue,
    >,
...
pub struct DmlStats {
    ...
    /// statements
    #[prost(message, optional, tag = "1")]
    pub inserted_row_count: ::core::option::Option<pb::Int64Value>,
    /// Output only. Number of deleted Rows. populated by DML DELETE, MERGE and
    /// TRUNCATE statements.
    #[prost(message, optional, tag = "2")]
    pub deleted_row_count: ::core::option::Option<pb::Int64Value>,
    /// Output only. Number of updated Rows. Populated by DML UPDATE and MERGE
    /// statements.
    #[prost(message, optional, tag = "3")]
    pub updated_row_count: ::core::option::Option<pb::Int64Value>,
}
...
pub struct TableMetadataCacheUsage {
    ...
    #[prost(message, optional, tag = "5")]
    pub staleness: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub struct ListJobsRequest {
    ...
    /// Leverage the page tokens to iterate through the entire collection.
    #[prost(message, optional, tag = "3")]
    pub max_results: ::core::option::Option<pb::Int32Value>,
    ...
    #[prost(message, optional, tag = "5")]
    pub max_creation_time: ::core::option::Option<
        super::super::super::protobuf::UInt64Value,
    >,
    /// Page token, returned by a previous call, to request the next page of
    /// results.
    #[prost(string, tag = "6")]
...
pub struct GetQueryResultsRequest {
    ...
    #[prost(message, optional, tag = "3")]
    pub start_index: ::core::option::Option<super::super::super::protobuf::UInt64Value>,
    /// Page token, returned by a previous call, to request the next page of
    /// results.
    #[prost(string, tag = "4")]
    pub page_token: ::prost::alloc::string::String,
    ...
    #[prost(message, optional, tag = "6")]
    pub timeout_ms: ::core::option::Option<pb::UInt32Value>,
    /// The geographic location of the job. You must specify the location to run
    /// the job for the following scenarios:
    ///
    /// * If the location to run a job is not in the `us` or
...
pub struct GetQueryResultsResponse {
    ...
    #[prost(message, optional, tag = "5")]
    pub total_rows: ::core::option::Option<super::super::super::protobuf::UInt64Value>,
    ...
    #[prost(message, repeated, tag = "7")]
    pub rows: ::prost::alloc::vec::Vec<::prost_wkt_types::Struct>,
    ...
    /// available.
    #[prost(message, optional, tag = "9")]
    pub job_complete: ::core::option::Option<super::super::super::protobuf::BoolValue>,
...
pub struct Routine {
    ...
    #[prost(message, optional, tag = "14")]
    pub strict_mode: ::core::option::Option<super::super::super::protobuf::BoolValue>,
...
pub mod routine {
    ...
    pub struct Argument {
        ...
        #[prost(message, optional, tag = "6")]
        pub is_aggregate: ::core::option::Option<
...
pub struct GetRoutineRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub read_mask: ::core::option::Option<::prost_wkt_types::FieldMask>,
}
...
pub struct MaterializedViewStatus {
    ...
    #[prost(message, optional, tag = "1")]
    pub refresh_watermark: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct CloneDefinition {
    ...
    /// reported in the JSON response using RFC3339 format.
    #[prost(message, optional, tag = "2")]
    pub clone_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub struct Table {
    ...
    /// the streaming buffer.
    #[prost(message, optional, tag = "11")]
    pub num_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. The physical size of this table in bytes. This includes
    /// storage used for time travel.
    #[prost(message, optional, tag = "26")]
    pub num_physical_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. The number of logical bytes in the table that are considered
    /// "long-term storage".
    #[prost(message, optional, tag = "12")]
    pub num_long_term_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. The number of rows of data in this table, excluding any data
    /// in the streaming buffer.
    #[prost(message, optional, tag = "13")]
    pub num_rows: ::core::option::Option<super::super::super::protobuf::UInt64Value>,
    ...
    #[prost(message, optional, tag = "15")]
    pub expiration_time: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "33")]
    pub num_time_travel_physical_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. Total number of logical bytes in the table or materialized
    /// view.
    #[prost(message, optional, tag = "34")]
    pub num_total_logical_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. Number of logical bytes that are less than 90 days old.
    #[prost(message, optional, tag = "35")]
    pub num_active_logical_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. Number of logical bytes that are more than 90 days old.
    #[prost(message, optional, tag = "36")]
    pub num_long_term_logical_bytes: ::core::option::Option<pb::Int64Value>,
    ...
    /// to a few minutes.
    #[prost(message, optional, tag = "53")]
    pub num_current_physical_bytes: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "37")]
    pub num_total_physical_bytes: ::core::option::Option<pb::Int64Value>,
    ...
    /// minutes.
    #[prost(message, optional, tag = "38")]
    pub num_active_physical_bytes: ::core::option::Option<pb::Int64Value>,
    /// Output only. Number of physical bytes more than 90 days old.
    /// This data is not kept in real time, and might be delayed by a few seconds
    /// to a few minutes.
    #[prost(message, optional, tag = "39")]
    pub num_long_term_physical_bytes: ::core::option::Option<pb::Int64Value>,
    ...
    #[prost(message, optional, tag = "40")]
    pub num_partitions: ::core::option::Option<pb::Int64Value>,
...
pub struct TableList {
    ...
    #[prost(message, optional, tag = "5")]
    pub total_items: ::core::option::Option<pb::Int32Value>,
}
/// Generated client implementations.
