...
pub mod time_target {
    ...
    pub enum Time {
        ...
        #[prost(message, tag = "1")]
        PublishTime(::prost_wkt_types::Timestamp),
        ...
        #[prost(message, tag = "2")]
        EventTime(::prost_wkt_types::Timestamp),
    }
}
...
pub struct ComputeMessageStatsResponse {
    ...
    #[prost(message, optional, tag = "3")]
    pub minimum_publish_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    #[prost(message, optional, tag = "4")]
    pub minimum_event_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
}
