...
pub struct GcipSettings {
    ...
    #[prost(message, optional, tag = "2")]
    pub login_page_uri: ::core::option::Option<
...
pub struct CorsSettings {
    ...
    #[prost(message, optional, tag = "1")]
    pub allow_http_options: ::core::option::Option<
...
pub struct OAuthSettings {
    ...
    #[prost(message, optional, tag = "2")]
    pub login_hint: ::core::option::Option<super::super::super::protobuf::StringValue>,
...
pub struct ApplicationSettings {
    ...
    #[prost(message, optional, tag = "3")]
    pub cookie_domain: ::core::option::Option<
        super::super::super::protobuf::StringValue,
    >,
...
pub struct CsmSettings {
    ...
    /// IAP.
    #[prost(message, optional, tag = "1")]
    pub rctoken_aud: ::core::option::Option<super::super::super::protobuf::StringValue>,
}
...
pub struct AccessDeniedPageSettings {
    ...
    #[prost(message, optional, tag = "1")]
    pub access_denied_page_uri: ::core::option::Option<
        super::super::super::protobuf::StringValue,
    >,
    /// Whether to generate a troubleshooting URL on access denied events to this
    /// application.
    #[prost(message, optional, tag = "2")]
    pub generate_troubleshooting_uri: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
    /// Whether to generate remediation token on access denied events to this
    /// application.
    #[prost(message, optional, tag = "3")]
    pub remediation_token_generation_enabled: ::core::option::Option<
        super::super::super::protobuf::BoolValue,
    >,
}
