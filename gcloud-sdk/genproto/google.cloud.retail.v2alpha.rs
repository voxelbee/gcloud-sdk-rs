...
pub struct PriceInfo {
    ...
    pub price_effective_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// The timestamp when the [price][google.cloud.retail.v2alpha.PriceInfo.price]
    ...
    pub price_expire_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct Product {
    ...
    pub available_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    pub available_quantity: ::core::option::Option<pb::Int32Value>,
    ...
    pub retrievable_fields: ::core::option::Option<::prost_wkt_types::FieldMask>,
...
pub struct Branch {
    ...
    #[prost(message, optional, tag = "5")]
    pub last_product_import_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct ProductDetail {
    ...
    #[prost(message, optional, tag = "2")]
    pub quantity: ::core::option::Option<pb::Int32Value>,
}
...
pub struct GetDefaultBranchResponse {
    ...
    #[prost(message, optional, tag = "2")]
    pub set_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// This corresponds to
...
pub struct Model {
    ...
    #[prost(message, optional, tag = "12")]
    pub last_tune_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct SetInventoryRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub set_mask: ::core::option::Option<::prost_wkt_types::FieldMask>,
...
pub struct AddFulfillmentPlacesRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub add_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// If set to true, and the [Product][google.cloud.retail.v2alpha.Product] is
...
pub struct AddLocalInventoriesRequest {
    ...
    /// is returned and the entire update will be ignored.
    #[prost(message, optional, tag = "4")]
    pub add_mask: ::core::option::Option<::prost_wkt_types::FieldMask>,
...
pub struct RemoveLocalInventoriesRequest {
    ...
    #[prost(message, optional, tag = "5")]
    pub remove_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// If set to true, and the [Product][google.cloud.retail.v2alpha.Product] is
