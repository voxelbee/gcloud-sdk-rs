...
pub struct CryptoKey {
    ...
    pub destroy_scheduled_duration: ::core::option::Option<::prost_wkt_types::Duration>,
...
pub mod crypto_key {
    ...
    pub enum RotationSchedule {
        ...
        /// support automatic rotation. For other keys, this field must be omitted.
        #[prost(message, tag = "8")]
        RotationPeriod(::prost_wkt_types::Duration),
    }
}
...
pub struct CryptoKeyVersion {
    ...
    /// generated.
    #[prost(message, optional, tag = "11")]
    pub generate_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    /// Output only. The time this
    ...
    /// [DESTROYED][google.cloud.kms.v1.CryptoKeyVersion.CryptoKeyVersionState.DESTROYED].
    #[prost(message, optional, tag = "6")]
    pub destroy_event_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
    ...
    pub import_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct PublicKey {
    ...
    pub pem_crc32c: ::core::option::Option<pb::Int64Value>,
...
pub struct ImportJob {
    ...
    pub expire_event_time: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct DecryptRequest {
    ...
    /// this type.
    #[prost(message, optional, tag = "5")]
    pub ciphertext_crc32c: ::core::option::Option<pb::Int64Value>,
    /// Optional. An optional CRC32C checksum of the
    ...
    /// this type.
    #[prost(message, optional, tag = "6")]
    pub additional_authenticated_data_crc32c: ::core::option::Option<pb::Int64Value>,
}
/// Request message for
...
pub struct RawEncryptRequest {
    ...
    #[prost(message, optional, tag = "4")]
    pub plaintext_crc32c: ::core::option::Option<pb::Int64Value>,
    /// Optional. An optional CRC32C checksum of the
    ...
    /// that support this type.
    #[prost(message, optional, tag = "7")]
    pub initialization_vector_crc32c: ::core::option::Option<pb::Int64Value>,
}
/// Request message for
...
pub struct AsymmetricSignRequest {
    ...
    /// this type.
    #[prost(message, optional, tag = "4")]
    pub digest_crc32c: ::core::option::Option<pb::Int64Value>,
    ...
    /// this type.
    #[prost(message, optional, tag = "7")]
    pub data_crc32c: ::core::option::Option<pb::Int64Value>,
}
/// Request message for
...
pub struct MacVerifyRequest {
    ...
    /// this type.
    #[prost(message, optional, tag = "5")]
    pub mac_crc32c: ::core::option::Option<pb::Int64Value>,
}
/// Request message for
...
pub struct AsymmetricSignResponse {
    ...
    /// languages that support this type.
    #[prost(message, optional, tag = "2")]
    pub signature_crc32c: ::core::option::Option<pb::Int64Value>,
    /// Integrity verification field. A flag indicating whether
    /// [AsymmetricSignRequest.digest_crc32c][google.cloud.kms.v1.AsymmetricSignRequest.digest_crc32c]
    /// was received by
    /// [KeyManagementService][google.cloud.kms.v1.KeyManagementService] and used
